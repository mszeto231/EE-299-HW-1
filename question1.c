...
// Write a simple C program to compute the price of a trip to Europe this summer for you
// and 8 of your best friends.The cost per person is $977.50 each with a 5 % discount and a
// 9.5% sales tax.Be certain to fully annotate your design.
